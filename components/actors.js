...
const setMovie = document.getElementById('setActors');
...
async function getActors() {
	...
	for (let i = 0; i < data.length; i++) {
        ...
        data-bs-title="name: ${data[i].name}  Data: ${data[i].release_date}"  id=myBtn style="width: 100%; min-height: 250px; cursor:pointer " >
          <img src=${img_url}${data[i].backdrop_path} class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title fs-7">${data[i].name}</h5>
